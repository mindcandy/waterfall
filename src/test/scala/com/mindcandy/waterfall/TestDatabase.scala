...
trait TestDatabase {
  ...
  def testDropLogs = List(
    ...
    DropLog(UUID.fromString("730c7f38-f911-41d7-8c94-9b6b819e8ef3"), 1, beforeReference2, Some(afterReference), None, Some("exception")),
    DropLog(UUID.fromString("c566c6c9-936c-40df-a1c0-c80ef228c620"), 1, beforeReference2, Some(beforeReference1), None, Some("exception")),
    DropLog(UUID.fromString("e4022b66-4985-451a-a548-eb2e5e30b609"), 1, afterReference, None, None, Some("exception")),
    DropLog(UUID.fromString("bcb9b181-2540-43b1-916c-7848775db7e9"), 1, beforeReference2, None, None, Some("exception")),
    ...
    DropLog(UUID.fromString("08502e67-8fd4-441f-bc75-91801e1577b2"), 2, beforeReference2, Some(afterReference), None, Some("exception")),
    DropLog(UUID.fromString("24d4d7ee-4440-45f1-9527-4453eb70a6e0"), 2, beforeReference2, Some(beforeReference1), None, Some("exception")),
    DropLog(UUID.fromString("7fdf3abb-916b-4266-a341-e48f534bf5ff"), 2, afterReference, None, None, Some("exception")),
    DropLog(UUID.fromString("c8ad6ada-f29f-4961-a695-380c442cd1da"), 2, beforeReference2, None, None, Some("exception"))
  )
